  ...
  return (
    <div className="PrivacyPolicy">
      ...
      <p>
        ...
        University of Birmingham. This privacy policy explains what personal
        data our organization collects, how we store your information, for how
        long, and how we utilise your data.
      </p>
      <div>
      ...
      <div>
        ...
        <p>
          You directly provide Fresher Friend with the majority of the data that
          is collected. We obtained process your information when you:
        </p>
        <ul>
        ...
        <p>
          Fresher Friend may also receive communication data indirectly from the
          following sources:
        </p>
        <ul>
      ...
      <div>
        ...
        <p>
          ...
          protected by conventional security measures. Fresher Friend will keep
          your personal data for 3 years. Once this time period has expired,
          your data will be deleted by removing it from our database.
        </p>
      </div>
      <div>
        ...
        <ul>
          ...
          <li>
            ...
            request that Fresher Friend restrict the processing of your personal
          ...
          <li>
            ...
            that Fresher Friend, transfer the data that we have collected to
            another organisation, or directly to you, under certain conditions.
          </li>
        </ul>
        <p>
          ...
          queries in connection with our Privacy Notice or wish to exercise any
          of your privacy rights, please contact us via email, post or telephone
          listed below.
        </p>
      </div>
      <div>
      ...
      <div>
        ...
        <p>
          Fresher Friend uses cookies in numerous ways in order to improve your
          experience while on our website, including:
        </p>
        <ul>
      ...
      <div>
        ...
        <p>
          ...
          selected preferences. This could include what language you prefer and
          your location. A mix of first-party and third-party cookies are in
          use.
        </p>
      </div>
      <div>
      ...
      <div>
        ...
        <p>
          The Fresher Friend website may contain links to other external sites.
          Our privacy policy applies only to our website.By clicking these
          links,it is then your responsibility to read their additional privacy
          policies.
        </p>
      </div>
      <div>
      ...
      <div>
        ...
        <p>
          Our privacy policy is subject to change. This policy was last updated
          on 8th March 2022.
        </p>
      </div>
    </div>
