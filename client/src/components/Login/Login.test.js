...
//    render(<App />);
//    async (dispatch) => {
//    await userEvent.type(screen.getByLabelText("emailInput"),"txg071@student.bham.ac.uk");
//    await userEvent.type(screen.getByLabelText("passwordInput"),"MySecurePassword");
//    const buttonE1 = screen.getByLabelText("loginButton");
//    await userEvent.click(buttonE1);
